                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="alignleft framed caption">
                            <img src="images/beveiliging/kiwa-logo.gif"  />
                            <p class="caption-tekst">KIWA Kwaliteitskeurmerk</p>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="alignleft framed caption">
                            <img src="images/beveiliging/ccv.gif"  />
                            <p class="caption-tekst">Centrum Criminaliteitspreventie en Veiligheid.</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        <p>Voor meer infromatie over het Kiwa CCV Borg Certificaat of Opleveringsbewijs <a href="PolairBorgcertificaat.php" title="Polair borgcertificaat">Klik hier</a></p>
                        <h3>Overname</h3>
                        <hr class="orange">
                        <p>Bent u al in het bezit van een bestaand alarmsysteem en/of brandmeldinstallatie? Polair Beveiliging neemt graag uw systeem onder zijn hoede met eventuele meldkamer- en onderhoudscontracten. 
                            Een uitbreiding of aanpassing van uw bestaande systeem is uiteraard ook mogelijk. Polair Beveiliging bied voor elke situatie een passende oplossing</p>
                    </div>
                </div>
            </div>
        </article>
