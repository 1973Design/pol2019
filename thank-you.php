                    ...
                    <div class="col-sm-12">
                        <div class="left-column">
                            <div class="left-column-content">
                                ...
                                <h2 class="text-center text-uppercase">Dank!</h2>
                                <p class="text-center w-75 m-auto">Voor het invullen van het formulier. We nemen zo snel mogelijk contact met u op.</p><br/><br/>
                                </div>
                                </div>
                            </div>
                        </div>
